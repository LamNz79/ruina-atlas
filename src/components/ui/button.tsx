...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-none text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        /* Primary — Deep Crimson with Gold inner-glow on hover per DESIGN.md */
        default: "bg-primary text-primary-foreground hover:bg-primary/90 hover:shadow-[inset_0_0_12px_rgba(245,197,24,0.3)]",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        /* Ghost Border — 15% opacity outline per DESIGN.md */
        outline:
          "border border-[rgba(200,193,180,0.15)] bg-background hover:bg-accent hover:text-accent-foreground",
        secondary:
